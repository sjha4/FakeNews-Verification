...
public class WekaClassifier {
    ...
    public WekaClassifier() {
        ...
        classAttributeValues.add("Real");
        classAttributeValues.add("Fake");
    ...
    public void transform() {
        try {
            if (new File(TRAIN_ARFF_ARFF).exists()) {
                ...
                System.out.println("Train data Found");
    ...
    public void fit() {
        try {
        	LOGGER.warn("Building classifier....");
    ...
    public String predict(String text) {
        try {
            ...
            newinstance.setValue(wekaAttributes.get(0), text);
